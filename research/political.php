...
$result = mysqli_query($con, "SELECT * FROM research WHERE type='political' ORDER BY publishdate DESC LIMIT 10");
...
<head>
    ...
    <title>Political Research - GIRI</title>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" role="form" action="new_research.php?TYPE=political" method="POST" enctype="multipart/form-data">
...
$(function(){
    $('#contents').scrollPagination(
        ...
        'contentData': {'page': function() {return page}, 'type': 'political'}, // these are the variables you can pass to the request, for example: children().size() to know which page you are
