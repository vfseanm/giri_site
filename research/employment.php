...
<head>
    ...
    <title>Employment Research - GIRI</title>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" role="form" action="new_research.php?TYPE=employment" method="POST" enctype="multipart/form-data">
