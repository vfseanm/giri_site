...
$result = mysqli_query($con, "SELECT * FROM research WHERE type='education' ORDER BY publishdate DESC LIMIT 10");
...
$(function(){
    $('#contents').scrollPagination(
        ...
        'contentData': {'page': function() {return page}, 'type': 'education'}, // these are the variables you can pass to the request, for example: children().size() to know which page you are
